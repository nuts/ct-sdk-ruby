  ...
  class ProductData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CtSdk::ProductData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CtSdk::ProductData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @master_variant.nil?
        invalid_properties.push('invalid value for "master_variant", master_variant cannot be nil.')
      end
      ...
      if @search_keywords.nil?
        invalid_properties.push('invalid value for "search_keywords", search_keywords cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @master_variant.nil?
      return false if @variants.nil?
      return false if @search_keywords.nil?
      true
    end
