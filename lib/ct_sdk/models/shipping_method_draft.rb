  ...
  class ShippingMethodDraft
    ...
    def self.openapi_types
      {
        ...
        :'zone_rates' => :'Array<ZoneRateDraft>',
        :'is_default' => :'Boolean',
        :'predicate' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CtSdk::ShippingMethodDraft` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CtSdk::ShippingMethodDraft`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @zone_rates.nil?
        invalid_properties.push('invalid value for "zone_rates", zone_rates cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @zone_rates.nil?
    ...
    def hash
      [key, name, description, localized_description, tax_category, zone_rates, is_default, predicate].hash
    end
