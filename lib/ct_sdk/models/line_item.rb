  ...
  class LineItem
    ...
    def self.openapi_types
      {
        ...
        :'distribution_channel' => :'ChannelReference',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CtSdk::LineItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CtSdk::LineItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @price_mode.nil?
        invalid_properties.push('invalid value for "price_mode", price_mode cannot be nil.')
      end

      if @line_item_mode.nil?
        invalid_properties.push('invalid value for "line_item_mode", line_item_mode cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @price_mode.nil?
      return false if @line_item_mode.nil?
      true
    end
    ...
    def hash
      [id, product_id, name, product_slug, product_type, variant, price, taxed_price, total_price, quantity, added_at, state, tax_rate, supply_channel, distribution_channel, discounted_price_per_quantity, price_mode, line_item_mode, custom, shipping_details, last_modified_at].hash
    end
